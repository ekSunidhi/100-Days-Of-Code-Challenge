...
class LoginForm:
    def __init__(self, window):
        ...
        self.signup_button=Image.open(r'images\\register.png')
        photo=ImageTk.PhotoImage(self.signup_button)
        self.signup_button_label=Button(self.lgn_frame, image=photo, bg='#040405', activebackground='#040405',
                                       cursor='hand2', bd=0)
        self.signup_button_label.image=photo
        self.signup_button_label.place(x=670, y=555, width=111, height=35)
        
        # ======= Show/Hide Password =======
        self.show_image=Image.open(r'images\\show.png')
        ...
        self.hide_image=Image.open(r'images\\hide.png')
