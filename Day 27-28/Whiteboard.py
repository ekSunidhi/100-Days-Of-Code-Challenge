...
def addLine(work):
    ...
    current_x, current_y=work.x, work.x, work.y
...
Button(root, image=eraser, bg="f2f3f5", command=new_canvas).place(x=30, =400)
...
slider=ttk.Scale(root, from_=0, to=100, orient='horzontal', command=slider_changed, variable=current_value)
